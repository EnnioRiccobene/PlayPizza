...
$sql = "select prodotti.idprod, prodotti.nomeprod, prodotti.ingredienti, prodotti.prezzo, prodotti.qord, preferiti.idpref, preferiti.idutente, preferiti.idprod, utente.idutente
from prodotti 
inner join preferiti 
on prodotti.idprod = preferiti.idprod 
inner join utente 
on utente.idutente = preferiti.idutente";
		...
		<div class="boxc2" id="boxc2" style="height: 100%">
			<div class="dropdown text-right">
				...
				<ul class="dropdown-menu dropdown-menu-right">
					...
					<li><a href="#">Aggiungi al carrello con modifica</a></li>
				</ul>
			</div>			
